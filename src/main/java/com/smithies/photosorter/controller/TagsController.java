...
import com.smithies.photosorter.component.tags.AddTagRequest;
...
public class TagsController {
	...
	public void addTagsToImage(@PathVariable("photoId") UUID photoId, @RequestBody TagPhotoRequest request) {
		AddOrRemovePhotoTagRequest addRequest = new AddOrRemovePhotoTagRequest();
